...
router.put('/roles/:id', protect, checkSubscriptionStatus, requirePermission('MANAGE_ROLES'), mongoIdValidation(), updateRole);
router.delete('/roles/:id', protect, checkSubscriptionStatus, requirePermission('MANAGE_ROLES'), mongoIdValidation(), deleteRole);
...
router.put('/team/:id', protect, checkSubscriptionStatus, requirePermission('MANAGE_USERS'), mongoIdValidation(), updateTeamMember);
router.post('/team/:id/reset-password', protect, checkSubscriptionStatus, requirePermission('MANAGE_USERS'), mongoIdValidation(), resetMemberPassword);
router.delete('/team/:id', protect, checkSubscriptionStatus, requirePermission('MANAGE_USERS'), mongoIdValidation(), deleteTeamMember);
