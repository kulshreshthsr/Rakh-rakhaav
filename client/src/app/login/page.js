    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-[46%] xl:w-[42%] flex-col justify-between bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-10 relative overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute -top-24 -left-24 w-72 h-72 rounded-full bg-green-500/10 blur-3xl" />
          <div className="absolute bottom-0 right-0 w-64 h-64 rounded-full bg-emerald-500/10 blur-3xl" />
        </div>
        ...
        <div className="relative z-10">
          ...
          <div className="mt-10 grid grid-cols-2 gap-3">
            {PERKS.map((p) => (
              <div key={p.label} className="flex items-center gap-2.5 px-3.5 py-3 rounded-xl bg-white/5 border border-white/8 hover:bg-white/8 transition">
      ...
      <div className="flex-1 relative flex flex-col justify-center px-5 py-10 sm:px-10 lg:px-16 xl:px-20">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          <div className="absolute bottom-6 -left-12 w-48 h-48 rounded-full bg-emerald-200/40 blur-3xl" />
        </div>
          ...
          <div className="relative bg-white/90 backdrop-blur-xl border-2 border-green-200 rounded-3xl shadow-[0_25px_60px_-35px_rgba(22,101,52,0.25)] p-6 sm:p-7 auth-card">
            ...
            <div className="flex flex-wrap gap-2 mb-5">
              {['GST-ready', 'Mobile-first', 'Fast billing'].map((item) => (
                <span
                  key={item}
                  className="inline-flex items-center px-2.5 py-1 rounded-full bg-white border border-green-200 text-[11px] font-semibold text-green-700 shadow-sm"
                >
                  {item}
                </span>
              ))}
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-[12px] font-bold text-green-700 hover:text-green-800 hover:underline transition-colors">
                  Forgot password?
                </Link>
              </div>
