...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch('https://rakh-rakhaav.onrender.com/api/auth/reset-password', {
        method: 'POST',
      ...
      <div style={{ minHeight: '100vh', background: '#f0f2f5', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Plus Jakarta Sans', sans-serif", padding: 16 }}>
        <div style={{ background: '#fff', borderRadius: 24, padding: '40px 32px', maxWidth: 420, width: '100%', boxShadow: '0 4px 40px rgba(0,0,0,0.08)' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 28 }}>
            <div style={{ fontSize: 22, fontWeight: 800, color: '#0f172a' }}>रख<span style={{ color: '#6366f1' }}>रखाव</span></div>
          </div>
          ...
          {success ? (
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: '#64748b', fontSize: 14, marginBottom: 28, lineHeight: 1.6 }}>Your password has been reset successfully. You can now login.</p>
            ...
            <>
              <h1 style={{ fontSize: 24, fontWeight: 800, color: '#0f172a', marginBottom: 6 }}>Reset password 🔑</h1>
              <p style={{ color: '#94a3b8', fontSize: 14, marginBottom: 28 }}>Enter your new password below.</p>
              ...
              <form onSubmit={handleSubmit}>
                <div style={{ marginBottom: 16 }}>
                  <label style={{ fontSize: 11, fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: 0.6, display: 'block', marginBottom: 6 }}>New Password</label>
                ...
                <div style={{ marginBottom: 24 }}>
                  <label style={{ fontSize: 11, fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: 0.6, display: 'block', marginBottom: 6 }}>Confirm Password</label>
