 ...
 *
 * Mirrors server/config/industries/index.js.
 ...
 * 'general' is kept as an internal fallback — NOT selectable in onboarding.
 *
...
export const INDUSTRIES = {
  ...
  hardware: {
    ...
    invoiceExtraFields: [
      ...
      { key: 'po_number',       label: 'Purchase Order No.',          type: 'text' },
      { key: 'vehicle_no',      label: 'Delivery Vehicle No.',        type: 'text' },
    ],
  },
 ...
 * Merges structural config with complete terminology from the business-configs engine.
 */
...
/** Selectable industries for onboarding picker — excludes general fallback. */
